...
public class VideoRepositoryTest {
    ...
    public void testAddSection(){
        ...
        List<Video> videoList = Arrays.asList(
                new Video("Environment Settings","https://res.cloudinary.com/qscloud/video/upload/v1634697286/st-school/videos/C%C3%A0i_%C4%91%E1%BA%B7t_m%C3%B4i_tr%C6%B0%E1%BB%9Dng_t2h1sb.mp4",course),
